...
public enum Blocking {
    ...
    public class WaiterContext: NSObject {
        ...
        fileprivate func wait(for expectation: Expectation, completion: @escaping (Expectation.Result) -> Void) throws {
            ...
            // (We signal both the main body of `waiterThread` and also its run loop to tell them that there is potentially a new expectation in the queue. Precisely one of them will actually end up waiting for the expectation.)
