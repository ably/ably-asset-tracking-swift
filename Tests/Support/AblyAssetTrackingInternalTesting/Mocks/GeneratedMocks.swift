...
public class AblyPublisherDelegateMock: AblyPublisherDelegate {
    ...
    public var ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdCallsCount = 0
    public var ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdCalled: Bool {
        return ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdCallsCount > 0
    }
    public var ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdReceivedArguments: (sender: AblyPublisher, presence: Presence, trackable: Trackable, presenceData: PresenceData, clientId: String)?
    public var ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdReceivedInvocations: [(sender: AblyPublisher, presence: Presence, trackable: Trackable, presenceData: PresenceData, clientId: String)] = []
    public var ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdClosure: ((AblyPublisher, Presence, Trackable, PresenceData, String) -> Void)?

    public func ablyPublisher(_ sender: AblyPublisher, didReceivePresenceUpdate presence: Presence, forTrackable trackable: Trackable, presenceData: PresenceData, clientId: String) {
        ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdCallsCount += 1
        ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdReceivedArguments = (sender: sender, presence: presence, trackable: trackable, presenceData: presenceData, clientId: clientId)
        ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdReceivedInvocations.append((sender: sender, presence: presence, trackable: trackable, presenceData: presenceData, clientId: clientId))
        ablyPublisherDidReceivePresenceUpdateForTrackablePresenceDataClientIdClosure?(sender, presence, trackable, presenceData, clientId)
    }
